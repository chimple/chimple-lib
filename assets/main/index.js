window.__require = function e(t, n, r) {
  ...
  1: [ function(require, module, exports) {
    (function(global) {
      ...
      const CapacitorPlatforms = initPlatforms("undefined" !== typeof globalThis ? globalThis : "undefined" !== typeof self ? self : "undefined" !== typeof window ? window : "undefined" !== typeof global ? global : {});
      ...
      const legacyRegisterWebPlugin = (cap, webPlugin) => {
        ...
        if (!config || !config.name) throw new Error('Capacitor WebPlugin is using the deprecated "registerWebPlugin()" function, but without the config. Please use "registerPlugin()" instead to register this web plugin."');
        console.warn(`Capacitor plugin "${config.name}" is using the deprecated "registerWebPlugin()" function`);
        (!Plugins[config.name] || (null === (_a = null === config || void 0 === config ? void 0 : config.platforms) || void 0 === _a ? void 0 : _a.includes(cap.getPlatform()))) && (Plugins[config.name] = webPlugin);
      };
      ...
      const getPlatformId = win => {
        var _a, _b;
        return (null === win || void 0 === win ? void 0 : win.androidBridge) ? "android" : (null === (_b = null === (_a = null === win || void 0 === win ? void 0 : win.webkit) || void 0 === _a ? void 0 : _a.messageHandlers) || void 0 === _b ? void 0 : _b.bridge) ? "ios" : "web";
      };
      const createCapacitor = win => {
        ...
        const capPlatforms = win.CapacitorPlatforms;
        const defaultGetPlatform = () => null !== capCustomPlatform ? capCustomPlatform.name : getPlatformId(win);
        const getPlatform = (null === (_a = null === capPlatforms || void 0 === capPlatforms ? void 0 : capPlatforms.currentPlatform) || void 0 === _a ? void 0 : _a.getPlatform) || defaultGetPlatform;
        const defaultIsNativePlatform = () => "web" !== getPlatform();
        const isNativePlatform = (null === (_b = null === capPlatforms || void 0 === capPlatforms ? void 0 : capPlatforms.currentPlatform) || void 0 === _b ? void 0 : _b.isNativePlatform) || defaultIsNativePlatform;
        const defaultIsPluginAvailable = pluginName => {
          const plugin = registeredPlugins.get(pluginName);
          if (null === plugin || void 0 === plugin ? void 0 : plugin.platforms.has(getPlatform())) return true;
          if (getPluginHeader(pluginName)) return true;
          return false;
        };
        const isPluginAvailable = (null === (_c = null === capPlatforms || void 0 === capPlatforms ? void 0 : capPlatforms.currentPlatform) || void 0 === _c ? void 0 : _c.isPluginAvailable) || defaultIsPluginAvailable;
        const defaultGetPluginHeader = pluginName => {
          var _a;
          return null === (_a = cap.PluginHeaders) || void 0 === _a ? void 0 : _a.find(h => h.name === pluginName);
        };
        const getPluginHeader = (null === (_d = null === capPlatforms || void 0 === capPlatforms ? void 0 : capPlatforms.currentPlatform) || void 0 === _d ? void 0 : _d.getPluginHeader) || defaultGetPluginHeader;
        const handleError = err => win.console.error(err);
        const pluginMethodNoop = (_target, prop, pluginName) => Promise.reject(`${pluginName} does not have an implementation of "${prop}".`);
        ...
        const defaultRegisterPlugin = (pluginName, jsImplementations = {}) => {
          ...
          const loadPluginImplementation = async () => {
            !jsImplementation && platform in jsImplementations ? jsImplementation = jsImplementation = "function" === typeof jsImplementations[platform] ? await jsImplementations[platform]() : jsImplementations[platform] : null !== capCustomPlatform && !jsImplementation && "web" in jsImplementations && (jsImplementation = jsImplementation = "function" === typeof jsImplementations["web"] ? await jsImplementations["web"]() : jsImplementations["web"]);
            return jsImplementation;
          };
          const createPluginMethod = (impl, prop) => {
            var _a, _b;
            if (!pluginHeader) {
              if (impl) return null === (_b = impl[prop]) || void 0 === _b ? void 0 : _b.bind(impl);
              throw new CapacitorException(`"${pluginName}" plugin is not implemented on ${platform}`, exports.ExceptionCode.Unimplemented);
            }
            {
              const methodHeader = null === pluginHeader || void 0 === pluginHeader ? void 0 : pluginHeader.methods.find(m => prop === m.name);
              if (methodHeader) return "promise" === methodHeader.rtype ? options => cap.nativePromise(pluginName, prop.toString(), options) : (options, callback) => cap.nativeCallback(pluginName, prop.toString(), options, callback);
              if (impl) return null === (_a = impl[prop]) || void 0 === _a ? void 0 : _a.bind(impl);
            }
          };
          const createPluginMethodWrapper = prop => {
            ...
            const wrapper = (...args) => {
              const p = loadPluginImplementation().then(impl => {
                ...
                if (fn) {
                  const p = fn(...args);
                  remove = null === p || void 0 === p ? void 0 : p.remove;
                  return p;
                }
        ...
        const registerPlugin = (null === (_e = null === capPlatforms || void 0 === capPlatforms ? void 0 : capPlatforms.currentPlatform) || void 0 === _e ? void 0 : _e.registerPlugin) || defaultRegisterPlugin;
      ...
      const Capacitor = initCapacitorGlobal("undefined" !== typeof globalThis ? globalThis : "undefined" !== typeof self ? self : "undefined" !== typeof window ? window : "undefined" !== typeof global ? global : {});
      ...
      class WebPlugin {
        ...
        notifyListeners(eventName, data) {
          const listeners = this.listeners[eventName];
          listeners && listeners.forEach(listener => listener(data));
        }
        ...
        async removeListener(eventName, listenerFunc) {
          ...
          this.listeners[eventName].length || this.removeWindowListener(this.windowListeners[eventName]);
        }
  ...
  profile: [ function(require, module, exports) {
    ...
    var User = function() {
      ...
      User.createUser = function(name, imgPath, age, gender, id, avatarImage, isTeacher) {
        ...
        var user = new User(uid, name, age, gender, imgPath, avatarImage, isTeacher, {}, "camp", "chimp", debug ? new Map([ [ "assignment", new CourseProgressClass() ], [ "en", new CourseProgressClass("en00") ], [ "maths", new CourseProgressClass("maths00") ], [ "hi", new CourseProgressClass("hi00") ], [ "mr", new CourseProgressClass("mr00") ], [ "puzzle", new CourseProgressClass("puzzle00") ], [ "test-lit", new CourseProgressClass("chapter_0") ], [ "test-maths", new CourseProgressClass("chapter_0") ] ]) : new Map([ [ "assignment", new CourseProgressClass() ], [ "en", new CourseProgressClass() ], [ "maths", new CourseProgressClass() ], [ "hi", new CourseProgressClass() ], [ "mr", new CourseProgressClass("mr00") ], [ "puzzle", new CourseProgressClass("puzzle00") ] ]), new Map(), new Map(), {}, {}, debug, [ "", "", "", "", "", "", "", "", "1", "2", "r", "1", "2", "r", "1", "2", "r" ]);
